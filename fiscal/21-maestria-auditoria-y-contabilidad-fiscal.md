...
En diciembre de 2023 el IFAC/IAASB aprobó la emisión de una **Norma Internacional de Auditoría para Entidades Menos Complejas (NIA-LCE / ISA for LCE)**, un estándar independiente y proporcional a la complejidad de la entidad, distinto del conjunto completo de NIA. El IMCP tradujo la norma y la publicó en el sitio de la IFAC el 18-ene-2024, y emitió el **Folio 47/2023-2024**, "Adopción de las NIA para Entidades Menos Complejas... a partir del 15 de diciembre de 2025" [3][4]. Aplica, por diseño del IAASB, a PyME privadas con estructuras simples, OSC sin operaciones complejas y entidades públicas pequeñas; **no aplica** a emisoras públicas, instituciones financieras reguladas ni grupos corporativos grandes [4]. **Inferencia:** el título del folio usa la palabra "Adopción", lo que indica que el IMCP formalizó su incorporación al catálogo mexicano; no se pudo leer el folio completo (403) para confirmar si queda a juicio del auditor o requiere un paso adicional de la CNBV para entidades reguladas. Es el hallazgo más relevante para un despacho pequeño: si el auditor decide que una PyME constructora es "entidad menos compleja", desde el 15-dic-2025 puede usar la NIA-LCE en vez del conjunto completo de NIA, con procedimientos más proporcionales.
