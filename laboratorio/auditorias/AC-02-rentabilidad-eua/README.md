...
- **Fuente B (reconstrucción):** Kenneth French, `6_Portfolios_ME_OP_2x3` (CSV mensual, *value-weighted*),
  ...
  Diferencia de construcción documentada: el RMW oficial de la versión 2x3 de 5 factores **no** usa sólo la partición tamaño × rentabilidad operativa de estos 6 portafolios en la forma reportada; según la documentación de French, los 6 portafolios que definen RMW se forman con cortes de tamaño y OP con el universo de la versión de 5 factores, y los breakpoints/filtros (p. ej. exigencia de datos de B/M, OP, inversión disponibles simultáneamente) pueden diferir de los del archivo `6_Portfolios_ME_OP_2x3`. Por eso se espera correlación alta pero no idéntica. Se compara mes a mes: correlación, diferencia media, desviación estándar de la diferencia, máximo |diferencia|, y número de meses con |diferencia| > 0.5 pp.
