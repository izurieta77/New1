...
- **Hoy:** breakeven a 10 años de 2.33%, 5y5y forward de 2.33% y rendimiento real a 10 años de 2.76%, el más alto desde nov-2008 (FRED, 23/24-sep-2026). El IPC de EUA (CPI-U) está en **3.4% a/a** (ago-2026, sin ajuste estacional; BLS, comunicado del 11-sep-2026, serie CUUR0000SA0: 334.980 / 323.976 − 1 = 3.40%). *[Corregido el 25-sep-2026 por el verificador: decía 3.71%. Ese número es el cambio de **13 meses** de FRED CPIAUCSL (ago-2026 contra jul-2025 = 3.713%). Sale de tomar un rezago de 12 observaciones en una serie donde falta oct-2025, que BLS no publicó por el cierre de gobierno de 2025. Ver `conocimiento/registro-de-errores.md`.]* *Inferencia (no cambia con la corrección):* el mercado no extrapola el choque de energía al largo plazo, así que las expectativas siguen ancladas.
...
- **Trayectoria:** recortes en sep, oct y dic-2025 (a 3.50-3.75%). En 2026 llegó un choque de energía (conflicto con Irán según el TBAC; Brent de US$138.21 el 7-abr-2026), el IPC de EUA pasó de **2.4% (feb) a 4.2% (may)** a/a, bajó a 3.4% en ago (BLS, sin ajuste estacional) y la Fed subió en septiembre. *[Corregido el 25-sep-2026 por el verificador: decía 2.66% y 4.27%. Es el mismo error de rezago de 13 meses sobre CPIAUCSL: feb-2026 contra ene-2025 da 2.665% y may-2026 contra abr-2025 da 4.270%. Ver `conocimiento/registro-de-errores.md`.]*
