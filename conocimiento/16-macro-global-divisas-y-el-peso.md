...
- **Paridad cubierta (CIP):** F/S = (1 + i_MXN)/(1 + i_USD). Es arbitraje, no pronóstico. Con Banxico en 6.50% y la Fed en 3.75-4.00%, el *forward* a un año de USD/MXN está alrededor de 2.4-2.65% **arriba** del spot (1.065/1.04 − 1 y 1.065/1.0375 − 1; el *forward* real se cotiza con tasas de mercado a un año, no con las de política, así que es aproximado).
...
Fama (1984) encontró que la pendiente de Δs sobre (f − s) es **negativa**, cuando la UIP exige 1. La moneda de tasa alta no se deprecia lo que dice el diferencial, y casi toda la variación del *forward* es prima por riesgo. La cifra de "alrededor de −2.4 a un mes en replicaciones" es (no verificado). Lo verificado: Snaith, Coakley y Kellard (2013, JBF 37: 3681-3693), con los cinco pares más operados contra el USD en 1980-2006 y horizontes de 1 mes a 10 años, encuentran que la pendiente se acerca a 1 al alargar el plazo y que el *puzzle* desaparece a 3 años o más en todas las monedas (fuente 1).
...
1. **Prima por riesgo de *crash* y factor global** (Brunnermeier-Nagel-Pedersen 2008; Lustig-Roussanov-Verdelhan 2011). Las monedas de tasa alta pierden cuando sube la aversión global y se seca el fondeo. **Contraevidencia que obliga a bajar esta explicación a B:** Jurek (2014, JFE 113(3): 325-347) cubre el *carry* del G10 con opciones fuera del dinero (1990-2012) y encuentra que la prima por *crash* explica **como máximo un tercio** del exceso de rendimiento; Burnside, Eichenbaum, Kleshchelski y Rebelo (2011, RFS; NBER w14054) hallan pagos grandes y **no correlacionados con los factores de riesgo tradicionales**; Daniel-Hodrick-Lu (2017) no logran explicar la rentabilidad con riesgos de acciones, bonos, FX, volatilidad ni *downside beta*. El sesgo negativo es un hecho (A); que sea *la* causa de la prima, no.
...
4. ***Peso problem***. Un salto raro y grande que no aparece en muestras cortas. El nombre viene del peso fijo de 1954-1976: el origen exacto del término es incierto y se atribuye en general a **Milton Friedman**; el primer tratamiento académico formal es **Krasker (1980), "The 'peso problem' in testing the efficiency of forward exchange markets", JME 6(2): 269-276**. Burnside et al. (2011) proponen una variante: el evento raro se caracteriza por un factor de descuento estocástico muy alto, no por pérdidas enormes del *carry*.
...
Rogoff (1996) documenta el consenso de una **vida media de 3 a 5 años** en las desviaciones de la PPP (confirmado en Taylor y Taylor 2004, NBER w10607, que añaden que con modelos no lineales los choques grandes se corrigen en menos de 3 años), combinada con una volatilidad de corto plazo enorme. Meese-Rogoff (1983): en los setenta, la caminata aleatoria le habría ganado fuera de muestra a todos los modelos estructurales para las monedas principales. Rossi (2013, JEL 51(4): 1063-1119) revisa la literatura posterior: la respuesta a "¿se puede pronosticar el tipo de cambio?" es "depende"; la predictibilidad aparece sobre todo con reglas de Taylor o activos externos netos, modelos lineales y pocos parámetros, y **la caminata aleatoria sin *drift* sigue siendo el rival más difícil**. **Dato (cálculo propio, BIS REER):** el peso real estaba en **139.8 en jul-2026**, contra un promedio de 127.3 entre 1994 y 2026, es decir, en el **percentil 73**. Tocó 144.6 en abr-2024 y 122.9 en dic-2024. Es un viento en contra a varios años, pero no una señal para una temporada de 6 meses.
...
- **Kaminsky-Reinhart (1999):** muestra de 20 países de Asia, Europa, América Latina y Medio Oriente entre 1970 y mediados de 1995. El *working paper* (IFDP 544, 1996) cuenta 25 crisis bancarias y 71 de balanza de pagos; la versión publicada se cita con 26 bancarias (confirmado vía fuente secundaria) y 76 cambiarias (no verificado en el texto de la AER). Los problemas bancarios **preceden** a la crisis cambiaria, y ésta los agrava en espiral. La liberalización financiera precede a las crisis bancarias. El caldo de cultivo es un auge de crédito, entradas de capital y moneda sobrevaluada que termina en recesión.
...
|---|---|---|---|---|
| 1 | Fama (1984), JME 14(3): 319-338 | La pendiente de Δs sobre (f − s) es **negativa** (el "≈ −2.4 a 1 mes" es no verificado). Casi toda la variación del *forward* es prima por riesgo | ideas.repec.org/a/eee/moneco/v14y1984i3p319-338.html | **A** (el hecho). **B** (su uso en series de tiempo, por Hassan-Mano) |
| 1b | Snaith-Coakley-Kellard (2013), JBF 37: 3681-3693 | Cinco pares principales, 1980-2006, 1 mes a 10 años: la pendiente tiende a 1 con el plazo y el *puzzle* desaparece a 3 años o más | doi.org/10.1016/j.jbankfin.2013.06.001 | **B** |
...
| 5 | Menkhoff-Sarno-Schmeling-Schrimpf (2012), JF 67(2): 681-718, *carry* y volatilidad FX global | Sharpe del *carry* **0.82** (según lo cita la fuente 4). Las monedas de tasa alta pierden cuando sube inesperadamente la volatilidad FX global; ese riesgo domina al de liquidez | doi.org/10.1111/j.1540-6261.2012.01728.x | **B** |
| 5b | Jurek (2014), JFE 113(3): 325-347 | *Carry* del G10 1990-2012 cubierto contra *crash* con opciones: la prima por *crash* explica **como máximo 1/3** del exceso | ideas.repec.org/a/eee/jfinec/v113y2014i3p325-347.html | **B** |
| 5c | Burnside-Eichenbaum-Kleshchelski-Rebelo (2011), RFS | Pagos del *carry* grandes y no correlacionados con factores tradicionales; *peso problem* vía factor de descuento alto, no pérdidas enormes | nber.org/papers/w14054 | **B** |
...
| 7 | Meese-Rogoff (1983), JIE 14(1-2): 3-24 | En los setenta, la caminata aleatoria habría superado fuera de muestra a todos los modelos para monedas principales | ideas.repec.org/a/eee/inecon/v14y1983i1-2p3-24.html | **A** |
| 7b | Rossi (2013), JEL 51(4): 1063-1119 | La predictibilidad "depende" del predictor, horizonte, muestra y método; la caminata aleatoria sin *drift* es el rival más duro | doi.org/10.1257/jel.51.4.1063 | **A** (el diagnóstico) |
...
| 12 | Kaminsky-Reinhart (1999), AER 89(3): 473-500 | 20 países, 1970-1995. La crisis bancaria precede a la cambiaria. La liberalización precede a la bancaria | aeaweb.org/articles?id=10.1257/aer.89.3.473 | **B** (descriptivo). **C** (alerta temprana) |
...
> **Adenda 2026-09-25 (examen diagnóstico S4-10/S5-06, ficha `conocimiento/fichas/2026-09-25-examen-S1-S5-huecos.md`).** El resumen de la fuente 15 estaba incompleto. Texto completo del hallazgo de Campbell, Serfaty-de Medeiros y Viceira (2010): entre 1975 y 2005, el USD (sobre todo frente al CAD), el EUR y el CHF (sobre todo en la segunda mitad del periodo) se mueven en contra de los mercados accionarios mundiales, y por eso atraen a los inversionistas globales en acciones que minimizan riesgo **pese a sus bajos rendimientos promedio**. Para un inversionista global en **bonos**, la estrategia de mínimo riesgo es una cobertura casi total, **con una posición larga modesta en USD**. **Hay poca evidencia de que convenga ajustar las posiciones cambiarias según los diferenciales de tasas de interés** (conecta con la discusión de *carry* del §5). https://www.nber.org/papers/w13088
...
| 20 | Koijen-Moskowitz-Pedersen-Vrugt (2018), "Carry", JFE 127(2): 197-225 | El *carry* predice rendimientos en acciones globales, bonos globales, divisas, materias primas, Treasuries, crédito y opciones sobre índices, y hay episodios en que todas pierden **a la vez, coincidentes con recesiones globales** | nber.org/papers/w19325 | **B** |
...
- **Tras el 2-jun-2024** (mayoría calificada de Morena), el USD/MXN pasó de 16.97 a 18.36 en una semana, **+8.19%** (Banco Base; corregido 2026-09-25, examen diagnóstico S4-10/S5-06: la cifra original decía "−8.19%", mezclando la convención de tipo de cambio con la de valor del peso). En valor del peso (USD por MXN), la depreciación fue de **≈−7.6%** [(1/18.36)/(1/16.97) − 1 = −7.57%]. Le siguió la reforma judicial con elección popular de jueces.
