...
- **Adenda 2026-09-25 (examen diagnóstico S5-03, ficha `conocimiento/fichas/2026-09-25-examen-S1-S5-huecos.md`).** Chan, Karceski y Lakonishok (2003), *"The Level and Persistence of Growth Rates"*, JF 58(2): 643-684 — confirmado contra el resumen del artículo — tienen **dos** hallazgos relevantes para el paso 4: **(1)** el crecimiento de largo plazo (histórico) tiene poca o ninguna persistencia más allá del azar, incluso con una amplia variedad de variables predictoras; **(2)** los **pronósticos de crecimiento de largo plazo (LTG) de los analistas de I/B/E/S son demasiado optimistas y aportan poco poder predictivo** — este segundo hallazgo es tan relevante como el primero al juzgar la plausibilidad de una g implícita, y antes de esta adenda solo se citaba el primero. https://onlinelibrary.wiley.com/doi/abs/10.1111/1540-6261.00540 Complemento metodológico citado pero sin cifras verificadas en esta tarea: Mauboussin, Callahan y Majd, *"The Base Rate Book"* (Credit Suisse/Morgan Stanley, 2016), con la distribución histórica de tasas de crecimiento a 10 años por tamaño inicial de la empresa **(no verificado)**.
- **Verificación de consistencia adicional al paso 4:** confirmar que g = tasa de reinversión × ROIC se sostenga durante **todo** el periodo explícito, no solo en el valor terminal, y que el FCFF de partida sea neto de SBC **y de arrendamientos** (no solo de uno de los dos).
