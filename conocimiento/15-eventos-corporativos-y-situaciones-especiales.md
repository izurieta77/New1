...
- Evidencia directa: en microcaps, la reacción a compras de insiders se concentra en 2-3 sesiones y en calendar-time sin el primer día no hay alfa (Zhao 2026 [23]); las inclusiones al S&P 500 de septiembre de 2025 saltaron ~7% en after-hours [49], antes de que un operador manual pudiera actuar.
...
Ejemplo: O = 50, P = 48.50, B = 38, d = 120. G = 3.09% (≈9.4% anual simple); p\* = 10.5/12 = 87.5%; L = 21.6%. Con p = 90%: E = 0.9×1.50 − 0.1×10.50 = 0.30 por acción (0.62%). Cada punto porcentual de probabilidad vale (O − B)/100 = 0.12 por acción (0.25% del precio). **Todo el edge está en estimar p mejor que el mercado por unos pocos puntos.** Un sistema con LLM logró un Brier balanceado de 0.151 sobre más de 400 tratos grandes en 42 países, 24% mejor que las probabilidades implícitas calibradas del mercado (Jajal et al., ICML 2026 [46]). Inferencia: para una IA, el único edge escalable en situaciones especiales es la estimación de probabilidades, y se mide con Brier antes de arriesgar capital.
...
| Congreso de EUA (y cónyuges) | Periodic Transaction Report | 45 días; operaciones >US$1,000; monto en **rangos** [54] | Señal vieja e imprecisa |
...
|---|---|---|---|---|---|---|
| Mitchell, Pulvino | 2001 | Characteristics of Risk and Return in Risk Arbitrage | JF 56(6) | 4,750 fusiones 1963-1998; ~**4%/año** de exceso **neto de costos** tras controlar la no linealidad; correlación con el mercado solo en caídas severas | [1] | B |
| Baker, Savasoglu | 2002 | Limited Arbitrage in Mergers and Acquisitions | JFE 64(1) | Cartera diversificada: **0.6-0.9%/mes** anormal, 1981-1996; más alto con mayor riesgo de cierre y objetivo más grande | [2] | B |
| Jetley, Ji | 2010 | The Shrinking Merger Arbitrage Spread | FAJ 66(2) | Spread −**400 pb** desde 2002; el alfa agregado de los fondos de merger arb cayó 41 pb/mes (≈4.81 pp/año) en 2002-2007 frente a periodos previos | [3] | A (decaimiento) |
| Ricks, Lin | 2024 | How Deals Die | HLS Forum | 5,058 acuerdos con objetivo público 1996-2020: ruptura de **9%** (calma) a **12%** (turbulencia), estable en 25 años | [4] | B |
| Cusatis, Miles, Woolridge | 1993 | Restructuring through Spinoffs | JFE 33(3) | 146 spin-offs 1965-1988: exceso vs pareadas **+25%** (2 años) y **+33.6%** (3 años) | [5] | C hoy |
| McConnell, Ovtchinnikov | 2004 | Predictability of Long-Term Spinoff Returns | JIM 2(3) | 36 años: excesos positivos en subsidiarias, significativos tras ajuste por riesgo | [6] | C |
| Veld, Veld-Merkoulova | 2009 | Value Creation through Spin-offs: A Review | IJMR | 26 estudios: **+3.02%** en el anuncio; el exceso de largo plazo **no sobrevive** a pruebas refinadas | [7] | B |
| Shleifer | 1986 | Do Demand Curves for Stocks Slope Down? | JF 41(3) | Inclusiones al S&P 500 desde sept-1976: retorno anormal positivo (~3%) que no revierte en ≥10 días; ligado a compras de fondos índice | [8] | A (histórico) |
| Greenwood, Sammon | 2025 | The Disappearing Index Effect | JF (abr-2025) | Adiciones: 3.4% (80s) → **7.4%** (90s) → **<1%** (2010-2020); eliminaciones: −0.1% en 2010-2020 | [9] | A |
| Ritter | 1991 | The Long-Run Performance of IPOs | JF 46(1) | IPOs 1975-84: **34.5%** a 3 años vs **61.9%** de las pareadas | [10] | A |
...
| Fu, Huang | 2016 | Persistence of Long-Run Abnormal Returns Following Repurchases and Offerings | MS 62(4) | 13,992 recompras: exceso positivo **hasta 2002**; desaparece en 2003-2012 | [17] | B (decaimiento) |
...
| Martin, Puthenpurackal | 2008 | Imitation Is the Sincerest Form of Flattery | WP SSRN | Imitar a Berkshire el mes siguiente a su divulgación: +10.75% a +14.26%/año según la medida (1976-2006); reacción de +4.03% el día de la divulgación | [25] | C |
...
| Rapach, Ringgenberg, Zhou | 2016 | Short Interest and Aggregate Stock Returns | JFE 121(1) | Short interest agregado: R² anual **12.89%** in-sample y **13.24%** out-of-sample; >300 pb/año de ganancia de utilidad | [27] | B |
| Boehmer, Jones, Zhang | 2008 | Which Shorts Are Informed? | JF 63(2) | Muy shorteadas rinden **−1.16%** en 20 días vs poco shorteadas (15.6% anual); con cortos institucionales, −1.43% | [28] | B (dato propietario) |
...
| Brav, Jiang, Partnoy, Thomas | 2008 | Hedge Fund Activism, Corporate Governance, and Firm Performance | JF 63 | **≈7%** anormal alrededor del anuncio, sin reversión a un año; éxito total o parcial en 2/3 de los casos | [30] | B |
| Becht, Franks, Grant, Wagner | 2017 | Returns to Hedge Fund Activism: An International Study | RFS 30(9) | EUA: **7.0%** en (−20, +20) días | [31] | B |
...
| Heitz, Narayanamoorthy, Zekhnini | 2020 | The Disappearing Earnings Announcement Premium | WP SSRN | La prima **desapareció en EUA** y migró a las fechas de 8-K tras la regla de divulgación de 2004; sigue robusta fuera de EUA | [33] | B |
...
| Ziobrowski et al. | 2004 | Abnormal Returns from the Common Stock Investments of the U.S. Senate | JFQA 39 | 1993-1998: compras **+85 pb/mes** (~12%/año) | [38] | D hoy |
| Eggers, Hainmueller | 2013 | Capitol Losses | JOP 75(2) | 2004-2008: portafolio promedio **−2 a −3%/año** vs índice (−0.23 pp/mes); los autores de 2004 no compartieron datos | [39] | B |
| Wei, Zhou | 2025 | "Captain Gains" on Capitol Hill | NBER w34524 | Legisladores que ascienden al liderazgo: **+47 pp/año** vs pares pareados tras el ascenso (20 líderes, 1995-2021) | [40] | C |
| Klausner, Ohlrogge, Ruan | 2022 | A Sober Look at SPACs | Yale J. on Reg. 39 | Efectivo neto al fusionar: mediana **US$5.70** (media 4.10) por cada US$10; post-fusión ≈**−50%** ajustado por mercado a 18 meses | [41][42] | A |
| Gahng, Ritter, Zhang | 2023 | SPACs | RFS | Inversionista de la IPO del SPAC que redime: **9.3%** anual | [43] | B |
...
| Bali, Hirshleifer, Peng, Tang (+Wang) | 2021- | Attention, Social Interaction, and Lottery Stocks | NBER w29543 | Más discusión en redes → rachas extremas → compras Robinhood → rendimientos posteriores menores | [45] | B |
| Jajal et al. | 2026 | Global Merger-Arbitrage Forecasting with Language Models | ICML 2026 / arXiv | Brier balanceado **0.151** (>400 tratos, 42 países); 24% mejor que las probabilidades implícitas calibradas | [46] | C |

---

## 4. Lo más reciente 2023-2026

1. **El efecto índice ya es historia académica.** Greenwood y Sammon (JF, abril 2025): de 7.4% en los 90 a menos de 1% en 2010-2020, pese a que hay más dinero indexado que nunca; la causa es que mesas de trading e indexadores anticipan y proveen liquidez [9]. Los saltos idiosincráticos siguen existiendo (Robinhood +~16% y AppLovin +~12% el día siguiente al anuncio de septiembre de 2025 [49]), pero ocurren en after-hours y en la primera sesión: no son capturables para un operador manual.
2. **PEAD: guerra de diseño de investigación.** En 2025, Dickerson-Julliard-Mueller (JFE) y Hirshleifer-Peng-Wang (RFS, t≈14) sostienen que la deriva está viva. Subrahmanyam la replica para feb-2001 a dic-2024: t = 2.18 con todas las acciones y **t = 1.43 sin microcaps** (el 20% inferior por capitalización de la NYSE, ~3% del valor de mercado) [35]. Veredicto operativo: muerta en lo invertible; viva, si acaso, donde el costo la anula.
3. **Insiders tras la reforma 10b5-1 (vigente desde feb-2023).** Kim, Kim y Rajgopal (2025): las ventas ejecutadas dentro de los 90 días posteriores a adoptar un plan pasaron de **31.1% a 1.7%**; el uso de planes bajó de 52.5% a 50.3% de las ventas; los retornos anormales negativos tras ventas bajo plan se volvieron planos [47]. Otro trabajo encuentra que la información de las **compras** no cambió y la de las ventas cayó (sin verificar el detalle cuantitativo). Oenschläger-Möllenhoff (FRL 2025): con montos por señal realistas, la ganancia se vuelve negativa [22]. Zhao (arXiv 2026): la reacción se agota en 2-3 sesiones [23].
...
5. **Reglas de divulgación.** 13D a 5 días hábiles (feb-2024); 13G trimestral para QII (sep-2024) [53]. Form SHO (cortos institucionales) pospuesto a feb-2028 tras la remisión judicial de agosto de 2025 [55].
...
7. **Merger arbitrage: régimen regulatorio.** En 2023-2024, la FTC y otros reguladores atacaron tratos emblemáticos (iRobot/Amazon terminado en ene-2024; demanda contra Kroger/Albertsons en feb-2024) y los spreads llegaron a sus niveles más anchos en años [57]. En 2025 hubo pocas rupturas y el HFRI ED: Merger Arbitrage ganó **8.2%** hasta septiembre, su mejor arranque de tres trimestres desde 2021 [58]. Lección: el riesgo principal del merger arb es **regulatorio y de régimen**, no de mercado.
8. **SPAC 2.0.** Reglas de la SEC vigentes desde julio de 2024 (sin safe harbor para proyecciones). Cerca de 100 IPOs de SPACs en los tres primeros trimestres de 2025 (~US$20.8 mil millones), contra 57 en 2024; patrocinadores seriales ≈78-80% de las IPOs de 2025; estructuras con menos warrants [59]. Pero los deSPACs siguen destruyendo valor: rendimiento a un año de **−59.1%** (cohorte 2023), **−62.0%** (2024) y **−55.7%** (2025), medido desde US$10 (Ritter, actualizado jul-2026 [60]).
...
10. **Meme stocks, versión 2025.** En julio de 2025, Opendoor subió más de 5 veces en el mes; Kohl's tenía ~49% de su flotante en corto y Opendoor ~21% [61]. La evidencia académica sobre compras por atención es consistentemente negativa: posiciones abiertas en el pico de atención de WallStreetBets rinden −8.5% [62]; recomendaciones de Reddit con alfa de largo plazo negativo y significativo [63].
11. **México: OPAs vivas.** Vinte deslistó a Javer vía OPA forzosa (dic-2024, 99.92% del capital, 4,288 mdp) [64]. Pantera Holdings (vehículo de accionistas existentes, vinculado al presidente ejecutivo de Traxión) lanzó una **OPA voluntaria a MXN 13.18** por hasta el 100% de las acciones, prima >20% sobre el promedio de 60 días; periodo de aceptación del 22-sep al 20-oct-2026 y liquidación prevista el 23-oct-2026; la empresa declara que **no** busca deslistarse [65][66]. Es el caso de laboratorio del §6.
12. **IA aplicada.** Un sistema LLM supera en 24% (Brier) a las probabilidades implícitas del mercado para predecir el desenlace de fusiones [46]. Es la primera evidencia seria de que la lectura masiva de documentos (proxy, acuerdos, condicionantes regulatorios) da ventaja en esta clase de activos. Grado C mientras no haya track record fuera de muestra con dinero real.
...
|---|---|---|---|---|---|---|
| **Merger arb en efectivo (EUA)** | ~4%/año sobre riesgo tras costos (1963-98) [1]; 0.6-0.9%/mes (1981-96) [2] | ETFs 2016-2026: CAGR 2.8-4.2% vs 2.3-2.8% de T-bills [§5.2]; spread −400 pb desde 2002 [3] | Spread de 2-5% por trato; rupturas de 9-12% [4] | 8-K, DEFM14A, SC TO-T | Solo si el objetivo está en el SIC; **el riesgo USDMXN domina el spread** | B |
| **Merger arb en acciones** | Igual | Igual | Requiere corto del adquirente | S-4, 425 | **No** (sin corto) | — |
| **OPA en BMV/BIVA** | Sin estudio académico local verificado | Caso a caso (prima 20-35% al anuncio) | Spread en MXN; 0.29% por lado | Eventos relevantes, folleto | **Sí** | C |
...
| **Inclusión en el S&P 500 (post-anuncio)** | ~3% (Shleifer) → 7.4% (90s) [8][9] | **<1%** (2010-2020) [9] | Salto en after-hours | Comunicados de S&P DJI | Sí, pero no capturable | D |
...
| **Comprar IPOs en el aftermarket** | 34.5% vs 61.9% a 3 años [10] | 1980-2024: −20.5% vs mercado, −8.9% vs estilo; 2012-2024: −25.5% / −16.7% [12]; no rentables: −30.7% / −23.4% | Primer día promedio 18.9% capturado solo por quien recibe asignación | S-1, 424B | Sí (evitar) | **B como filtro** |
...
| **Compras de insiders** | >6%/año (retorno del insider) [20]; oportunistas +82 pb/mes [21] | Positivo bruto y concentrado en small/microcaps; **negativo al escalar** [22]; reacción de 1-3 días [23] | 2 días hábiles; microcaps ilíquidas | Form 4 | Mayormente **no** (microcaps fuera del SIC) | B bruto / C neto |
...
| **Short interest agregado (timing)** | R² OOS 13.24% anual [27] | Sin verificación post-2014 | Mensual/quincenal | FINRA | Solo como insumo de exposición | B |
...
| **Prima de anuncio de resultados** | 9.9% anual [32] | **Desaparecida en EUA**, migró a los 8-K [33] | Rotación alta | Calendario de resultados | Sí | C |
| **PEAD** | Clásico | Muerto en large caps desde 2006 [34]; t = 1.43 sin microcaps [35] | Rotación alta | 8-K / consenso | Sí | C |
| **Revisiones de analistas** | Cambios del consenso: predictor robusto [37] | Proveedor: decil superior − inferior 7.6%/año, 2003-2022 [68] | Datos de pago (I/B/E/S) | Consenso | Sí | B (señal compuesta) |
| **Copiar al Congreso** | Senado +85 pb/mes (1993-98) [38] | Congreso −2 a −3%/año (2004-08) [39]; ETFs = beta tecnológica | 45 días; montos en rangos | PTRs | ETFs no listados en SIC (no verificado) | D |
| **Líderes del Congreso** | +47 pp/año vs pares [40] | Sin prueba implementable con 45 días de rezago | 45 días | PTRs | — | C |
| **Comprar deSPACs** | −50% ajustado a 18 meses [41] | −55.7% a −62.0% a un año (cohortes 2023-2025) [60] | — | S-4, 8-K | Sí (evitar) | **A como filtro** |
| **SPAC antes de la fusión (con redención)** | 9.3% anual [43] | SPAC 2.0 con menos warrants [59] | Unidades y warrants | S-1 | No (no verificado) | B (inaccesible) |
...
Cálculo propio con precios ajustados de Yahoo Finance al 24-sep-2026, en USD y con dividendos reinvertidos. En MXN hay que sumar la variación del USDMXN, cuya volatilidad realizada fue de 10.8% anual en 5 años y 8.2% en el último año; el cambio a 84 días hábiles tuvo p5 = −7.6% y p95 = +10.7%.
...
- **Asimetría del merger arb**: se gana 2-5% por trato en 3-9 meses; un objetivo roto cae típicamente 20-40% en una sesión (práctica de mercado, no verificado académicamente; ejemplo: Shutterstock −29% al terminarse el trato con Getty [57]). Un trato roto borra de 5 a 10 éxitos.
...
- **deSPACs 2012-2022**: −46.3% a un año y −57.7% a tres años en promedio [60].
...
- G, L, p\*, anualizado y **p propia** con justificación escrita. Base de referencia: 88-91% de cierre en términos originales [4], ajustada por riesgo regulatorio, financiamiento y régimen de crédito.
...
**R5. Caso de laboratorio en papel: OPA de Traxión (fase 0, sin dinero real).** Datos al 24-sep-2026: P = 12.90 (cierre, Yahoo); O = 13.18 [65][66]; B ≈ 11.00 (cierres del 8 al 14 de septiembre, entre 10.90 y 11.09); liquidación prevista el 23-oct-2026.
- G = 2.17% bruto; neto de 0.29% de compra ≈ 1.88% (se desconoce el costo de aceptar la OPA en GBM: verificar); ≈24% anualizado simple en 28 días; ISR del 10% por el art. 129 LISR si aplica a enajenación vía OPA (verificar con contador; no verificado) [70].
- p\* = 1.90/2.18 = **87%**; L = 14.7%.
- Tamaño arena teórico = 0.03 × 20,000 / 0.147 ≈ **4,080 MXN** (20% de la cuenta, debajo del 30% individual). Ganancia esperada si cierra ≈ 77 MXN. Inferencia: con 20 mil pesos, las situaciones especiales valen como **sustituto de CETES con cola**, no como motor de ganancia.
- Tarea: registrar hoy p propia, fecha y fuentes; al liquidarse, calcular el Brier. Riesgos a revisar en el folleto: condiciones de terminación, mínimo de aceptación, prorrateo y liquidez residual (si baja el flotante por debajo del mínimo regulatorio, la permanencia en bolsa podría reconsiderarse [66]).
...
- Cada arbitraje consume una de las `operaciones_max_mes` (8); un trato ocupa dos (entrada y liquidación por OPA).

**R7. Pipeline de datos (para la rutina de escaneo, en papel).**
- **EDGAR**: feed de filings recientes por tipo (4, SC 13D, 8-K, SC TO-T, DEFM14A); JSON por emisora en `data.sec.gov/submissions/`; conjuntos trimestrales de Forms 3/4/5 [51]. La SEC exige un User-Agent identificable.
...
- **Congreso**: sitios de divulgación de la Cámara y del Senado; uso analítico, no operativo.
...
**R8. Registro y calibración.** Toda situación especial genera un pronóstico probabilístico (cierre en términos / mejora / ruptura) que entra al contador de `pronosticos` (Brier objetivo ≤0.20, mínimo 50 pronósticos). Meta de referencia: acercarse al 0.151 del sistema LLM de Jajal et al. [46]. Si después de 50 pronósticos el Brier no mejora a p\*, no hay edge y la estrategia no pasa a capital real.
...
2. **En el ejemplo anterior, con perfil `arena_agresivo` y capital de 20,000 MXN, ¿cuál es el nocional máximo por riesgo?**
   0.03 × 20,000 / 0.147 ≈ **4,080 MXN**, debajo del 30% de acción individual.
...
3. **¿Qué encontraron Mitchell y Pulvino sobre la correlación del merger arb con el mercado y cuánto exceso queda neto de costos?**
   Casi nula en mercados planos o alcistas y **positiva en caídas severas**; ~**4%/año** de exceso tras controlar la no linealidad y los costos.

4. **¿Cuánto se comprimió el spread de merger arb después de 2002 y por qué?**
   Más de **400 pb**; más capital en la estrategia, más negociación de los objetivos y menores costos (Jetley-Ji).
...
12. **¿Qué predice el efectivo neto por acción de un SPAC y cuál fue el rendimiento a un año de los deSPACs 2023-2025?**
    Predice casi uno a uno el valor posterior a la fusión (mediana de US$5.70 por cada US$10 en 2019-2020); **−59.1%, −62.0% y −55.7%**.
...
11. Ritter, IPO Data (actualizado ene-2026): https://site.warrington.ufl.edu/ritter/ipo-data/
...
25. Martin, Puthenpurackal (2008), SSRN: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=806246
...
33. Heitz, Narayanamoorthy, Zekhnini, "The Disappearing Earnings Announcement Premium": https://www.ssrn.com/abstract=3296537 ; PDF: https://www.iimb.ac.in/ARC2020/Papers/The_Disappearing_Earnings_Announcement_Premium.pdf
34. Martineau (2022), Critical Finance Review 11(3-4): https://www.nowpublishers.com/article/Details/CFR-0122 ; https://cfr.pub/forthcoming/papers/martineau2021rest.pdf
...
45. Bali, Hirshleifer, Peng, Tang, Wang, NBER w29543: https://www.nber.org/papers/w29543
46. Jajal et al. (2026), "Global Merger-Arbitrage Forecasting with Language Models", ICML 2026: https://arxiv.org/abs/2607.09921
47. Kim, Kim, Rajgopal (2025), "Insider Trading After the 2022 Rule 10b5-1 Amendment", CLS Blue Sky: https://clsbluesky.law.columbia.edu/2025/07/31/insider-trading-after-the-2022-rule-10b5-1-amendment/ ; JAE: https://www.sciencedirect.com/science/article/abs/pii/S0165410126000765
...
57. InsideArbitrage (2025), riesgos de merger arb: https://www.insidearbitrage.com/2025/04/merger-arbitrage-risk-analysis/ ; Sculptor (2024): https://www.sculptor.com/news/2024-04-03-merger-arbitrage-revisited ; Associated Capital Group, Form ARS FY2024: https://www.sec.gov/Archives/edgar/data/1642122/000143774925013369/acars.pdf
58. LPL Research, "Merger Arbitrage 2025 Performance": https://www.lpl.com/research/blog/merger-arbitrage-rebound.html
59. With Intelligence, SPAC Market 2025: https://www.withintelligence.com/insights/a-cautious-rebound-spacs-enjoy-renewed-interest-in-2025/ ; FTI: https://www.fticonsulting.com/insights/articles/spac-comeback-whats-different-time
...
62. "Social media attention and retail investor behavior: Evidence from r/wallstreetbets", IRFA (2024): https://www.sciencedirect.com/science/article/pii/S1057521924006537
63. "Financial recommendations on Reddit, stock returns and cumulative prospect theory" (PMC): https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10111308/
64. Real Estate Market, Vinte deslista a Javer: https://realestatemarket.com.mx/noticias/mercado-inmobiliario/47318-vinte-deslista-a-javer-de-la-bmv-tras-adquirir-el-99-92-de-su-capital
...
71. Datos de precios (cálculo propio de CAGR, beta, MDD y volatilidad USDMXN): Yahoo Finance chart API, series ajustadas de MNA, MRGR, ARB, CSD, IPO, PKW, GURU, GVIP, NANC, GOP, SPY, QQQ, BIL, MXN=X y TRAXIONA.MX al 24/25-sep-2026.
