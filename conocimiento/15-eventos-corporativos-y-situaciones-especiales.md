...
4. **Estudio de proveedor (grado D, útil como contraste):** 47,458 compras de insiders (ene-2020 a ago-2025): +2.56% a un año sobre la acción mediana (t = 5.84), pero **no sobrevive a un placebo** de ventana desplazada 180 días (diferencia real − placebo de 1.40 pp, t = 1.58), y el decil de compras más grandes rinde 17.10 pp **menos** que el de las más chicas, efecto que sí sobrevive al placebo (t = −3.20 vs −0.99) [48]. Sin ajuste por riesgo y con sesgo de supervivencia.
...
49. CNBC (5-sep-2025), AppLovin y Robinhood al S&P 500 (403 al verificar; los movimientos al cierre siguiente se recalcularon con [71]): https://www.cnbc.com/2025/09/05/applovin-robinhood-sp-500.html
...
58. LPL Research, "Merger Arbitrage 2025 Performance" (403 al verificar): https://www.lpl.com/research/blog/merger-arbitrage-rebound.html
...
61. Reuters vía U.S. News (24-jul-2025), Opendoor y Kohl's (503 al verificar): https://money.usnews.com/investing/news/articles/2025-07-24/opendoor-kohls-resume-rally-as-meme-stock-frenzy-continues
...
Verificación adversarial sobre la versión entregada por el autor. Herramientas: WebFetch sobre las fuentes citadas, metadatos y abstracts de OpenAlex/Crossref/Semantic Scholar por DOI, PDFs de Ritter, NBER, LBS, CBS, Kettell y Gahng-Ritter-Zhang, texto congelado de la LISR del repositorio y recálculo propio con la API de Yahoo Finance. El presupuesto de WebSearch de la sesión estaba agotado; no se usó ningún buscador alterno.

**Revisados: ~70 elementos. Correctos sin cambio: ~44. Corregidos: 26. Marcados "(no verificado)" o retirados de la evidencia: 24.**

**A. Confirmados (fuente primaria o recálculo).** Mitchell-Pulvino (4,750 fusiones, 1963-98, 4%/año neto, correlación solo en caídas severas); Jetley-Ji (>400 pb desde 2002); Ricks-Lin (5,058 acuerdos, 9-12%); Veld-Veld-Merkoulova (26 estudios, +3.02%); Shleifer (desde sept-1976, sin reversión en ≥10 días; ≈3% vía Greenwood-Sammon); Greenwood-Sammon (7.4% → <1%); Ritter 1991 (1,526 IPOs, 34.47% vs 61.86%, leído en el escaneo del artículo); tablas de Ritter (9,253 IPOs, 18.9%, +19.1%, −20.5%, −8.9%; 2012-2024 −25.5%/−16.7%; no rentables −30.7%/−23.4%; ventas <US$100M −40.9%; desde oferta +8.3%; 2025: 90 IPOs, 29.3%; 2024: 15.3%; 1980-2025: 19.0%, mediana 7.0%; deSPACs −59.1/−62.0/−55.7 y −46.3/−57.7); Loughran-Ritter (5%/7%); Pontiff-Woodgate; Ikenberry et al. (12.1%/45.3%); Peyer-Vermaelen; Fu-Huang (desaparece 2003-2012); Lee-Park-Pearson; Lakonishok-Lee (solo compras informan); Jeng-Metrick-Zeckhauser (>6%); Cohen-Malloy-Pomorski (82 pb/mes); Oenschläger-Möllenhoff; Zhao (13,534 compras, 4.13% vs 0.86%, 2-3 sesiones, v2 del 24-sep-2026); Antón-Cohen-Polk (2.8-4.5%); Angelini-Iqbal-Jivraj (3.80%, Sharpe 0.75); Rapach-Ringgenberg-Zhou (12.89%/13.24%, >300 pb); Boehmer-Jones-Zhang (−1.16%, −1.43%); Hong et al. (1.2%/mes); Brav et al. (≈7%, 2/3); **Becht, Franks, Grant, Wagner: autores confirmados en la página del artículo (repositorio LBS con cita RFS 30(9) 2933-2971) y 7.0% en (−20, +20) para Norteamérica**; Savor-Wilson (9.9%); Subrahmanyam (t = 2.18/1.43) y Martineau vía UCLA Anderson Review; Kettell-McInnis-Zhao; Jegadeesh et al.; Ziobrowski (85 pb/mes); Eggers-Hainmueller (−0.23 pp/mes, 2-3%/año, negativa a compartir datos); Wei-Zhou (+47 pp/año); Klausner-Ohlrogge-Ruan (US$5.70/4.10; −50% a 18 meses); Barber et al. (−4.7%; herding +42%/−9%); Jajal et al. (0.151, 24%); Kim-Kim-Rajgopal (31.1% → 1.7%; 52.5% → 50.3%); Equibles; tesis CBS (609 spin-offs, +28.5%, −1.7% a 14 días); Boyar (−2.7%/año); Mill Street (7.6%/año); reglas SEC (13D a 5 días hábiles y enmiendas en 2; 13G desde 30-sep-2024; Form 4 a 2 días hábiles desde ago-2002; 10b5-1 vigente 60 días tras su publicación; Form SHO al 14-feb-2028 tras la remisión del 25-ago-2025); STOCK Act (máximo 45 días, 5 U.S.C. §13105(l)); NANC (TER 0.72% y top 5 exactos); comisión GBM 0.25% + IVA hasta 1 millón de pesos promedio operado. **Recálculo propio:** CAGR, beta, MDD, Sharpe y años sueltos de los 10 ETFs de §5.2 (diferencias ≤0.1 pp); volatilidad USDMXN de 10.8% (5 años) y percentiles −7.6%/+10.7%; precios de Traxión (8-14 sep entre 10.90 y 11.09; 12.90 el 24-sep); aritmética de G, L, p\*, E[r], Kelly y R3(d) (umbral de 11.5%). **Endpoints:** `data.sec.gov/submissions/CIK##########.json`, feed `getcurrent` de EDGAR, página de Insider Transactions Data Sets, divulgación de la Cámara, eFD del Senado y FINRA short interest respondieron.

**B. Corregidos en sitio.**
1. **Gahng-Ritter-Zhang (error de fondo):** el 9.3% es el rendimiento a un año de los inversionistas **PIPE**, no del inversionista de la IPO del SPAC que redime. Este último ganó **23.9% anual EW** (458 SPACs, 2010-2020), con advertencia de que las cohortes 2021+ rendirán mucho menos. Se corrigió en §3 y §5.1.
2. Greenwood-Sammon: las eliminaciones en 2010-2020 promedian **0.1%** en el JF (no −0.1%) y −0.6% en la versión NBER; el 3.4% de los 80 es de la versión NBER (7.6% en los 90 y 0.8% en la última década en esa versión).
3. Ziobrowski: 85 pb/mes ≈ 10%/año; el "12%/año" es el resumen del autor ante el Congreso sobre una diferencia de ≈1%/mes.
4. Jetley-Ji: se retiró "41 pb/mes (≈4.81 pp/año)". No se verificó y la aritmética no cuadra (41 × 12 = 4.92).
5. Fu-Huang: se retiró la cifra "13,992 recompras" (no verificada) y se corrigió el título; el hallazgo incluye también a las SEOs.
6. Cusatis et al.: +25.5% (no +25%) a 2 años, con la fuente secundaria declarada.
7. Bali et al.: el título real es "Social Interactions and Lottery Stock Mania".
8. Heitz et al.: título real del WP; grado **B → C** (WP sin publicar y sin reverificar el detalle).
9. Short interest agregado en el catálogo §5.1: grado **B → C** (sin prueba post-publicación; el OOS del paper está dentro de su propia muestra).
10. Martineau: el enlace a cfr.pub **redirige hoy a un sitio ajeno** (secuestro de dominio); se reemplazó por el DOI.
11. SPAC 2025: With Intelligence no contiene las cifras citadas (~100 IPOs, US$20.8 mil millones, 57 en 2024, 78-80% de patrocinadores seriales). Se reemplazaron por las de FTI (138 SPACs, US$25.8 mil millones; US$8.7 mil millones en 2024).
12. deSPACs 2023-2025: se miden desde US$10 hasta el cierre del 31-dic, no exactamente a un año.
13. Opendoor: no subió "más de 5 veces en el mes": llegó a ≈6 veces en su máximo del 21-jul y cerró julio ≈3.5 veces arriba.
14. Vinte/Javer: la nota es del 5-feb-2025 (desliste aprobado con 99.94%), no de dic-2024.
15. Traxión: se agregaron la prima exacta (20.4% sobre el VWAP de 60 días de 10.95), las 542.38 millones de acciones, los 7,148.6 mdp, el vínculo de la oferente con el presidente ejecutivo, el salto de +13.3% del 15-sep y el requisito de 12% de flotante y 100 inversionistas.
16. **R5 contra `config/parametros.json`:** el tamaño por riesgo (4,080 MXN) queda debajo de `orden_minima_mxn` (5,000). Con la orden mínima, el riesgo de ruptura sería 3.7% del capital, arriba del 3% permitido. **La OPA no es ejecutable con los parámetros actuales.** Se corrigieron R5 y la pregunta 2 del examen.
17. R6: la redacción era contradictoria ("consume una… ocupa dos"). Se dejó como dos operaciones (criterio) y se agregaron la orden mínima y la rotación máxima.
18. R8: el 0.151 de Jajal et al. es un Brier balanceado por clase con tres desenlaces, no comparable con el Brier binario del contador. Se sustituyó por la prueba relativa contra el Brier de p\*.
19. R3: Ricks-Lin miden **no consumación**, no "cierre en términos originales"; se aclaró que la tasa base es de EUA.
20. ISR de la OPA: se agregó lo que dice el texto de la LISR (art. 129, numeral 3: excluye del 10% las enajenaciones fuera de bolsa y las "operaciones de registro o cruces protegidos"). La LISR vigente no tiene una disposición expresa sobre OPAs; la conclusión sigue **no verificada**.
21. §5.3: "un trato roto borra de 5 a 10 éxitos" era inconsistente con los rangos citados; con G de 2-5% y L de 20-40% son 4-20 éxitos.
22. Shutterstock −29%: la fuente [57] no lo contiene. La caída de −29.0% el 1-jul-2026 se verificó en precios; la causa (terminación con Getty), no.
23. Fuente [57]: InsideArbitrage y Sculptor no contienen iRobot, Kroger ni "spreads más anchos". Associated Capital sí contiene "widest levels in years"; las fuentes se reordenaron.
24. §4.3: se retiró como evidencia la afirmación sin fuente sobre las compras de insiders tras la reforma 10b5-1.
25. Venta en corto en GBM: existe con margen, solo en emisoras que GBM selecciona y con mínimo de 10,000 MXN (parcialmente verificado en el repo), así que "sin corto" pasa a "en la práctica no garantizado".
26. Detalles de precisión: Equibles (t = 1.58 del placebo; el efecto tamaño sí sobrevive), Jajal (tres desenlaces), fecha de la página de Ritter (9-mar-2026, no ene-2026), autores de [62] y [63], ventana de 5 años de los percentiles del USDMXN, plazo de los PTR (30/45 días), después de la inclusión al S&P (+15.8%/+11.6% al cierre siguiente) y DJM "en prensa".

**C. Pendientes marcados "(no verificado)".** Magnitudes de Baker-Savasoglu (0.6-0.9%/mes; abstract inaccesible); cifras de Martin-Puthenpurackal; muestra de Wei-Zhou (20 líderes, 1995-2021); detalle de Heitz et al.; HFRI ED Merger Arbitrage +8.2% en 2025 (LPL, 403); short interest de Kohl's (~49%) y Opendoor (~21%) (503); fechas de iRobot/Amazon y Kroger/Albertsons (no reverificadas en esta sesión); salto de ~7% en after-hours de las inclusiones de sep-2025 (CNBC, 403); caída típica de 20-40% de un objetivo roto (sin estudio académico); causa de la caída de Shutterstock; rango de primas de OPA de 20-35%; spread típico de 2-5% por trato; **ISR del 10% en una OPA**; **costo de GBM por aceptar una OPA**; **mínimo de aceptación, prorrateo y causas de terminación del folleto de Traxión**; **listado en el SIC de NANC/GOP** (Yahoo no muestra `.MX`: indicio, no prueba); **unidades y warrants de SPACs en el SIC**; **ausencia de microcaps en el SIC** (el repositorio solo da una cota inferior de cobertura de grandes caps); cobertura de GBM Trading USA; **desempeño post-2014 del predictor de Rapach et al.**; **rendimiento neto de anticipar inclusiones**; revista (JAE) de Kim-Kim-Rajgopal; patrocinadores seriales y warrants en SPAC 2.0.

**D. Fórmulas.** p\* = (P − B)/(O − B), G, L, anualizado simple y compuesto, E[r] = p·G − (1 − p)·L, nocional = riesgo × capital / L, 1 + R_MXN = (1 + R_USD)·(FX_final/FX_inicial) y G > 2σ√(d/365): correctas y coherentes con los ejemplos. p\* ignora el valor temporal y la prima de riesgo; como está escrito ("neutral al riesgo, sin valor temporal"), no exagera.

**Veredicto:** el capítulo es sólido en el núcleo académico y en los cálculos propios. Tenía un error de fondo (el 9.3% de los SPACs), un conflicto operativo con `config/parametros.json` (orden mínima contra riesgo por operación en R5), una fuente con dominio secuestrado y varias cifras de mercado atribuidas a fuentes que no las contienen. Todo quedó corregido o marcado. Ninguna regla operable descansa ya sobre una cifra no verificada sin advertirlo.
