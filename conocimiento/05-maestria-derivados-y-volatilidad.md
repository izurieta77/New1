...
- Ni, Pearson, Poteshman y White (2021, RFS 34(4):1952-1986): relación negativa, estadística y económicamente significativa, entre la volatilidad de rendimiento de la acción y las posiciones netas compradas de inversionistas que probablemente cubren (gamma positiva del cubridor ⇒ menor volatilidad). Magnitud puntual no verificada en esta sesión (solo resumen, cuerpo del artículo tras paywall).

> **Adenda fechada 2026-09-25 (examen diagnóstico S7-12, ficha `conocimiento/fichas/2026-09-25-examen-S7-complejidad-y-0dte.md`).** Magnitudes exactas que faltaban en este capítulo, verificadas hoy:
> - **Adams, Fontaine, Ornthanalai (2024), SSRN 4881008, "The Market for 0DTE: The Role of Liquidity Providers in Volatility Attenuation".** La volatilidad del índice **baja 60-90 puntos base anualizados** en días con trading 0DTE. Identificación: las opciones semanales SPXW con vencimiento martes y jueves no existían hasta el 26-abr y el 19-may-2022 respectivamente (introducción escalonada, usada como quasi-experimento). Nivel de acceso: resumen por triangulación de búsquedas (SSRN devolvió HTTP 403 en este entorno), no lectura del PDF.
> - **Amaya, D., Garcia-Ares, P., Pearson, N., Vasquez, A. (25-ene-2025), "0DTE Index Options and Market Volatility: How Large is Their Impact?", investigación patrocinada por Cboe (también en SSRN 5113405, con el orden de autores "Vasquez, Amaya, Pearson, Garcia-Ares").** Con datos propietarios de Cboe con dirección de la operación firmada, jul-2020 a jun-2023: el efecto de la gamma agregada de los OMM sobre la volatilidad es en promedio **−0.2pp**, con máximo de **+3.3pp en la volatilidad diaria anualizada** y **+6.4pp en la volatilidad de 30 minutos**. Nivel de acceso: **lectura íntegra** del PDF (`cdn.cboe.com/resources/education/research_publications/gammasqueezes.pdf`, 48 páginas, texto extraído con `pypdf`), con cita textual: "the maximum impact of OMM gamma on annualized daily volatility is to increase it by 3.3 percentage points... The maximum impact of OMM gamma on annualized 30-minute volatility is to increase it by 6.4 percentage points."
> - Estas dos cifras estaban listadas como fuentes #47 y #50 en la sección 9 sin la magnitud en el cuerpo del capítulo; ese fue el hueco exacto que señaló el acta de S7-12.
...
- **Brogaard, Han y Won (WP, SSRN 4426358).** El volumen mensual de 0DTE pasó de 0.08 millones de contratos (ene-2011) a 34.4 millones (ago-2023), 48% del volumen de opciones de índice. Una desviación estándar más de 0DTE eleva la volatilidad 9.10% respecto de su media, impulsada por minoristas especulativos. *(Adenda 25-sep-2026: el año de la versión exacta con esta cifra queda "2023" contra la publicación en el sitio de SSRN — vs "2024" que usan el enunciado y la clave del examen S7-12 y varios resúmenes recientes — sin resolver en esta sesión; **no verificado** cuál es la fecha correcta de la revisión citada. La cifra de 9.10% y el volumen de 34.4 millones se confirmaron por triangulación de resúmenes independientes.)*
...
50. Vasquez, Amaya, Pearson, Garcia-Ares (2025, WP; SSRN 5113405) — https://doi.org/10.2139/ssrn.5113405 [25-sep-2026: verificado con lectura íntegra vía el PDF paralelo alojado por Cboe (mismo trabajo, orden de autores "Amaya, Garcia-Ares, Pearson, Vasquez" en la portada, fechado 25-ene-2025): https://cdn.cboe.com/resources/education/research_publications/gammasqueezes.pdf ; cifras: efecto medio −0.2pp, máximo +3.3pp diario anualizado, +6.4pp en 30 minutos, muestra jul-2020 a jun-2023]
50b. Ni, S., Pearson, N., Poteshman, A., White, J. (2021). Does Option Trading Have a Pervasive Impact on Underlying Stock Prices? *RFS* 34(4):1952-1986. https://doi.org/10.1093/rfs/hhaa082 [añadido 25-sep-2026; DOI confirmado por resolución directa (doi.org redirige a academic.oup.com/rfs/article/34/4/1952/5873587, misma paginación); nivel de acceso: resumen, cuerpo del artículo tras paywall]
