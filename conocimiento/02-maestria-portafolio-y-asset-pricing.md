...
- **¿Cuántos años para demostrar habilidad?** t ≈ IR·√T. Para un IR de 0.5 hacen falta 16 años para llegar a t = 2 y **36 años** para t = 3. La mayoría de los "track records" no distingue habilidad de suerte.
...
5. **Umbral estadístico:** t ≥ 3.0 en el backtest (HLZ 2016). Además aplican `validacion_estrategias`: ≥10 años, costos y slippage incluidos, probabilidad de Deflated Sharpe ≥ 0.95, PBO ≤ 0.25, papel ≥ 3 meses y ≥ 30 operaciones, y capital inicial al 25%.
