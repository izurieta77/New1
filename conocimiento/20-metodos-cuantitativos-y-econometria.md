...
- **R5. Colas.** Ningún VaR normal. Los escenarios de estrés son mínimos: −19% en un día para el índice de EUA (1987), −14% para el IPC (1997) y +9% en un día para USD/MXN (2008). El stop y el tamaño (`riesgo_por_operacion`) se calculan suponiendo que un salto así atraviesa el stop.
